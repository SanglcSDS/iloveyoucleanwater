...
import 'package:iloveyoucleanwater/views/introduce/introduce_tab_view.dart';
    ...
    return Scaffold(
      ...
      headerSliverBuilder: (context, idex) => [
        SliverAppBar(
          ...
          centerTitle: true,
          title: Container(
            child: Text('introduce'.tr, style: TextStyle(color: primaryColor)),
          ),
        )
      ],
      body: IntroduceTabNew(),
