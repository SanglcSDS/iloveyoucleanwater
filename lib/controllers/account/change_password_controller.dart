...
class ChangePasswordController extends GetxController {
  ...
  void onChangePwd(BuildContext context, String oldPwd, String newPwd, String confirmPwd) async {
    EasyLoading.show(status: "change_pwd_progress".tr);
    Response response = await _accountProvider.changePassword(oldPwd, newPwd, confirmPwd);
